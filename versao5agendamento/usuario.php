...
// Buscar agendamentos
$sqlAgendamentos = "SELECT a.id, a.data, a.horario, a.status, s.nome AS nome_servico 
                    FROM agendamentos a 
    ...
    <div class="agendamentos">
        ...
        <table>
            ...
            <?php while ($row = $agendamentos->fetch_assoc()) {
                ...
                $aguardando = is_null($statusAtual) || $statusAtual === '' || strtolower($statusAtual) === 'null';
            ?>
                <tr>
                    <td><?php echo $row['nome_servico']; ?></td>
                    <td><?php echo $row['data']; ?></td>
                    <td><?php echo $row['horario']; ?></td>
                    <td><?php echo $aguardando ? 'Aguardando aprovação' : $statusAtual; ?></td>
                    <td>
                        <?php if ($aguardando): ?>
